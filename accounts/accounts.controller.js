...
function appleSignUp(req, res, next) {
    accountService.appleSignUp(req.body, req.get('origin'), req.ip)
    .then(({ refreshToken, ...account }) => {
        setTokenCookie(res, refreshToken);
        res.json({ refreshToken, ...account });
    })
...
function appleLogin(req, res, next) {
    accountService.appleLogin(req.body, req.ip)
    .then(({ refreshToken, ...account }) => {
        setTokenCookie(res, refreshToken);
        res.json({ refreshToken, ...account });
    })
...
function getByParams(req, res, next) {
    accountService.getByParams(req.body)
...
function deletemany(req, res, next) {
    accountService.deletemany(req.body)
