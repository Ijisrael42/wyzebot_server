...
function getByUserId(req, res, next) {
    ...
    washingsService.getByUserId(req.params.id)
        .then(washing => washing ? res.json(washing) : res.sendStatus(404))
        .catch(next);
}
...
function getBySupplierId(req, res, next) {
    ...
    washingsService.getBySupplierId(req.params.id)
        .then(washing => washing ? res.json(washing) : res.sendStatus(404))
        .catch(next);
}
...
function getBySupplierStatusId(req, res, next) {
    ...
    washingsService.getBySupplierStatusId(req.params)
        .then(washing => washing ? res.json(washing) : res.sendStatus(404))
        .catch(next);
}

function getByParams(req, res, next) {
    washingsService.getByParams(req.body)
